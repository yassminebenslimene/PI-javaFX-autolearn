...
public class FrontNavHelper {
    ...
    public static void goCours() {
        try { MainApp.showFrontoffice(); } catch (Exception e) { e.printStackTrace(); }
    }

    public static void goChallenges() {
        try {
            javafx.fxml.FXMLLoader loader = new javafx.fxml.FXMLLoader(
                FrontNavHelper.class.getResource("/views/frontoffice/showchallenges.fxml"));
    ...
    public static void goCommunaute() {
