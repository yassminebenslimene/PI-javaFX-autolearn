 ...
 *   Quiz card
 *     ÔööÔöÇÔöÇ [S├®lectionner] ÔåÆ "+ Nouvelle Question" + question cards inline below
 *           ÔööÔöÇÔöÇ [S├®lectionner] ÔåÆ "+ Nouvelle Option" + option rows inline below
 */
public class QuizController {
    ...
    // ÔöÇÔöÇ Full rebuild ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    private void chargerTout() {
        ...
        if (quizzes.isEmpty()) {
            Label empty = new Label(searchTerm.isBlank()
                ? "Aucun quiz. Cr├®ez-en un avec ┬½ + Nouveau Quiz ┬╗."
                : "Aucun quiz trouv├® pour ┬½ " + searchTerm + " ┬╗.");
    ...
    // ÔöÇÔöÇ Quiz block (card + optional questions inline) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    private Node buildQuizBlock(Quiz quiz, int index) {
        ...
        // If this quiz is expanded ÔåÆ show questions inline below
    ...
    private Node buildQuizCard(Quiz quiz, int index) {
        ...
        // Row 1: S├®lectionner + Voir
        HBox row1 = new HBox(6);
        row1.setAlignment(Pos.CENTER_RIGHT);

        boolean isExpanded = expandedQuizId != null && expandedQuizId == quiz.getId();

        // S├®lectionner ÔÇö vert si actif, gris sinon
        Button btnSelect = new Button(isExpanded ? "Ô£ô S├®lectionn├®" : "Ô£ô S├®lectionner");
        ...
        // Voir ÔÇö bleu
        Button btnVoir = new Button("ÔèÖ Voir");
        btnVoir.setStyle(
        ...
        // Modifier ÔÇö or/amber
        Button btnEdit = new Button("Ô£Ä Modifier");
        btnEdit.setStyle(
        ...
        // Supprimer ÔÇö rouge
        Button btnDel = new Button("­ƒùæ Supprimer");
        btnDel.setStyle(
    ...
    // ÔöÇÔöÇ Questions section (inline below quiz) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    private Node buildQuestionBlock(Question q, int index, int quizId) {
        ...
        Label typeLabel = new Label("­ƒö▓ Type: Standard");
        typeLabel.setStyle("-fx-text-fill:rgba(245,245,244,0.4); -fx-font-size:11;");
        Label ptsLabel = new Label("Ôÿà " + q.getPoint() + " points");
        ...
        // Right: S├®lectionner + Voir + Modifier + Supprimer
        VBox right = new VBox(4);
        right.setAlignment(Pos.CENTER_RIGHT);
        ...
        // If this question is expanded ÔåÆ show options inline below
        if (isExpanded) {
    ...
    // ÔöÇÔöÇ Options section (inline below question) ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    private Node buildOptionRow(Option opt, int index, int questionId) {
        ...
        Label badge = new Label(opt.isEstCorrecte() ? "Ô£ô Correcte" : "Ô£ù Incorrecte");
    ...
    // ÔöÇÔöÇ Quiz CRUD ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    private void supprimerQuiz(Quiz quiz) {
        Alert confirm = new Alert(Alert.AlertType.CONFIRMATION,
            "Supprimer le quiz ┬½ " + quiz.getTitre() + " ┬╗ ?\nToutes ses questions seront supprim├®es.",
            ButtonType.YES, ButtonType.NO);
        confirm.setHeaderText(null);
        confirm.showAndWait().ifPresent(r -> {
            if (r == ButtonType.YES) {
                boolean ok = serviceQuiz.supprimer(quiz);
                showAlert(ok, "Quiz supprim├® avec succ├¿s !", "├ëchec de la suppression du quiz.");
                if (ok) {
                    if (expandedQuizId != null && expandedQuizId == quiz.getId()) {
                        expandedQuizId = null;
                        expandedQuestionId = null;
    ...
    // ÔöÇÔöÇ Question CRUD ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    private void supprimerQuestion(Question q) {
        ...
        confirm.showAndWait().ifPresent(r -> {
            if (r == ButtonType.YES) {
                ...
                showAlert(ok, "Question supprim├®e avec succ├¿s !", "├ëchec de la suppression de la question.");
                if (ok) {
    ...
    private void voirQuestion(Question q) {
        ...
        info.setTitle("D├®tails de la Question");
    ...
    // ÔöÇÔöÇ Option CRUD ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    ...
    private void supprimerOption(Option opt) {
        ...
        confirm.showAndWait().ifPresent(r -> {
            if (r == ButtonType.YES) {
                ...
                showAlert(ok, "Option supprim├®e avec succ├¿s !", "├ëchec de la suppression de l'option.");
                if (ok) chargerTout();
            }
        });
    }
