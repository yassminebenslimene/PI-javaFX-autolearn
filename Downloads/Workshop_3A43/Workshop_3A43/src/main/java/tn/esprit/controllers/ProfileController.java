...
public class ProfileController {
    ...
    private void onSave() {
        ...
        successLabel.setText("Ô£ö  Profil mis ├á jour avec succ├¿s !");
    ...
    private boolean validate() {
        ...
        if (prenom.isEmpty() || prenom.length() < 2) { errorPrenom.setText("Pr├®nom invalide (min 2 car.)"); valid = false; }
        ...
        if (!pwd.isEmpty()) {
            if (pwd.length() < 6) { errorPassword.setText("Minimum 6 caract├¿res"); valid = false; }
