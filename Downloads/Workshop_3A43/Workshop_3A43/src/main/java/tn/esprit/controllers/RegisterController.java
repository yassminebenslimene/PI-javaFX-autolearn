...
public class RegisterController {
    ...
    private boolean validate() {
        ...
        if (email.isEmpty()) { errorEmail.setText("L'email est obligatoire"); valid = false; }
            ...
            if (exists) { errorEmail.setText("Cet email est d├®j├á utilis├®"); valid = false; }
        }
        ...
        if (password.isEmpty()) { errorPassword.setText("Le mot de passe est obligatoire"); valid = false; }
            ...
            errorPassword.setText("Maj + min + chiffre + sp├®cial (@$!%*?&)"); valid = false;
        }
        ...
        // R├┤le
        if (role == null) { errorRole.setText("Le r├┤le est obligatoire"); valid = false; }

        // Niveau
        if ("ETUDIANT".equals(role) && (niveau == null || niveau.isEmpty())) {
            errorNiveau.setText("Le niveau est obligatoire pour un ├®tudiant"); valid = false;
        }
