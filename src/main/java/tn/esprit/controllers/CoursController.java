...
public class CoursController {
    ...
    private void loadTable() {
        ...
        serviceChapitre.getAll().forEach(ch -> chapitreCountByCours.merge(ch.getCoursId(), 1, Integer::sum));
        ...
        if (labelTotalCours != null) labelTotalCours.setText(String.valueOf(serviceCours.getAll().size()));
        if (labelTotalChapitres != null) labelTotalChapitres.setText(String.valueOf(serviceChapitre.getAll().size()));
    }
